...
const App: React.FC = () => {
  ...
  const uploadPhoto = async (imageBlob: Blob) => {
    ...
    try {
      const response = await fetch(" https://nasty-crypt-xgr6rqp6r4v3xpr-5000.app.github.dev//recognize_food", {
        method: "POST",
        headers: {
  ...
  const getNutritionalData = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(` https://nasty-crypt-xgr6rqp6r4v3xpr-5000.app.github.dev//get_nutritional_data?food_item=${foodInput}`);
      const responseJson = await response.json();
  ...
  const handleSubmit = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(" https://nasty-crypt-xgr6rqp6r4v3xpr-5000.app.github.dev//save_log", {
        method: "POST",
        headers: {
